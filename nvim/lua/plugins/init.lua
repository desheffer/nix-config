...
require("packer").startup({
    function (use)
        ...
        use_lock {"rmagatti/session-lens", config = load_config, after = "telescope.nvim"}
        ...
        use_lock {"romgrk/nvim-treesitter-context", config = load_config, after = "nvim-treesitter"}
